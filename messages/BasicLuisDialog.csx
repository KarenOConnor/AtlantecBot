...
public class BasicLuisDialog : LuisDialog<object>
{
    ...
    {
        await context.PostAsync($"You have reached the BookEvent intent. You said: {result.Query}"); //
        context.Wait(MessageReceived);
    }
    ...
    {
        await context.PostAsync($"You have reached the EventLocation intent. You said: {result.Query}"); //
        context.Wait(MessageReceived);
    }
